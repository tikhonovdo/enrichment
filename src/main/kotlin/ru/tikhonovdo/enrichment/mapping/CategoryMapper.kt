...
class CategoryMapper(
    ...
    fun findCategoryIdByName(categoryName: String): CategoryRecord? {
        ...
        return financePmCategories.firstOrNull { category -> category.name == categoryName }
    }
