...
class AlfabankFileWorker(
    ...
    override fun readFile(content: ByteArray): List<DraftTransaction> {
        ...
        /* todo: У Альфы нет времени совершения транзакции - только дата.
         ...
         * быть уверенным в порядке транзакций внтури дня. Однако, если в парсер попадут данные за половину дня --
